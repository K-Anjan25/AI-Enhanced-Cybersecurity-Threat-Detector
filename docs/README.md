...
| [`ml-pipeline.md`](ml-pipeline.md) | ML Ops | Training→serving pipeline, model versioning, feature contract |
| [`../k8s/README.md`](../k8s/README.md) | Infra | Kubernetes manifests for backend, ml-service, dashboard, HPA, ingress |
