      ...
      <div className="w-full max-w-md bg-app-surface border border-line-subtle rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <form onSubmit={form.handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 bg-gradient-to-r from-accent-primary to-accent-secondary hover:opacity-90 disabled:opacity-60 text-brand-ink rounded-lg text-sm font-semibold transition duration-150 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/40"
          >
