    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-16 border-b border-line-subtle shrink-0">
          <div className="w-8 h-8 rounded-lg bg-brand-gradient-soft border border-accent-primary/20 flex items-center justify-center">
          ...
          <button
            ...
            className="ml-auto w-9 h-9 rounded-lg bg-app-subtle border border-line-subtle text-content-secondary hover:text-content-primary transition flex items-center justify-center cursor-pointer"
          >
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-3 space-y-2">
          {!loading && pending.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center px-6">
              <div className="w-12 h-12 rounded-2xl bg-app-subtle border border-line-subtle flex items-center justify-center">
              ...
              {pending.map((c) => (
                <li key={c.id}>
                  <button
                    type="button"
                    onClick={() => goCase(c.id)}
                    className="w-full text-left rounded-xl border border-line-subtle bg-app-bg p-3.5 hover:border-accent-primary/40 hover:bg-app-surface-raised transition group cursor-pointer"
                  >
        ...
        <div className="p-4 border-t border-line-subtle shrink-0 bg-app-subtle/40">
          <button
            type="button"
            onClick={() => {
              close();
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-brand-gradient text-brand-ink text-sm font-semibold hover:opacity-90 transition shadow-float cursor-pointer"
          >
