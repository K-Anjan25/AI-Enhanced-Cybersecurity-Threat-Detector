...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Advanced Hub", path: "/advanced", icon: Layers },
      { name: "Detection & Response Labs", path: "/next", icon: Layers },
      { name: "Cloud & Compliance Labs", path: "/future", icon: Layers },
      { name: "Data & Resilience Labs", path: "/advanced-phases", icon: Layers },
      { name: "Coverage & Collaboration Labs", path: "/final-phases", icon: Layers },
      { name: "Approvals & Exposure Labs", path: "/ultra-phases", icon: Layers },
      { name: "Federation & Autopilot Labs", path: "/federated-autopilot", icon: Layers },
